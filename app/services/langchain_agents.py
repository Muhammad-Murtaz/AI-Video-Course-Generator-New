...
from app.db.model import ChapterContentSlide, User, Course
    ...
    def create_course(
        ...
        if len(user_courses) >= 4:
            raise HTTPException(
                ...
                detail="Course creation limit reached for free users. Please upgrade your plan.",
            )
